...
export default function Platform() {
    return (
        <>
            <SharedHead
                title="smbCloud Platform - Learn smbCloud - A new cloud."
                description="Learn smbCloud Platform, a new cloud platform. For your explosive ideas: a controlled demolition."
            />
